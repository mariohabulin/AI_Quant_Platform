...
try:
    ...
    from research_evidence_compaction import (
        POSITIVE_INFINITY_PROFIT_FACTOR as _POSITIVE_INFINITY_PROFIT_FACTOR,
    )
    from research_evidence_compaction import (
...
POSITIVE_INFINITY_PROFIT_FACTOR = _POSITIVE_INFINITY_PROFIT_FACTOR
...
class TimeframeSensitivityStudyRunner:
    ...
    def _profile_summary(asset_result):
        return profile_summary(asset_result)
