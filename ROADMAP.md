...
- [ ] Reproduce Round 1 Causal Signals focused/full regression and hash-bound
  review on Windows, then commit and push the exact signal-only milestone.
- [ ] Implement the four family-specific next-open execution adapters with
