...
- [ ] Reproduce Round 2 Causal Signals focused/full regression and hash-bound
  review on Windows, then commit/push before synthetic family execution.
