...
- [ ] Reproduce Round 2 Family Execution focused/full regression and hash-bound
  review on Windows, then commit/push before discovery-runner implementation.
